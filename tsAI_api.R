...
#' tsAI 时序数据取值变化原因分析
#' @param data 请求的具体时序数据 (e.g. '[{"Sepal.Length":5.1,"Sepal.Width":3.5,"Petal.Length":1.4,"Petal.Width":0.2,"Species":"setosa"},{"Sepal.Length":4.9,"Sepal.Width":3,"Petal.Length":1.4,"Petal.Width":0.2,"Species":"setosa"}]')
#' @param conf 配置项信息  (e.g. '{"var_time": "rq", "var_indx_target": "y", "var_indxs": ["y1","y2","y3","y4"], "var_factors": ["f1","f2","f3"], "time_select": "2019-11-21"}')
#' @post /ts
function(data, conf){
  # print("====dat====")
  # print(data)
